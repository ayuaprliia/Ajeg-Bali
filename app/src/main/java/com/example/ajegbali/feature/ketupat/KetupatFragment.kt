...
import com.example.ajegbali.feature.jejahitan.ScanActivity
...
class KetupatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = JejahitanAdapter(dataList) { item ->
            val intent = Intent(requireContext(), com.example.ajegbali.feature.jejahitan.DetailActivity::class.java)
